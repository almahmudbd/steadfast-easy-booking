    ...
    <div id="sfb-bulk-table-wrap" style="display:none; margin-top:20px;">
        <div class="sfb-card">
            ...
            <div style="margin-top:20px; padding:15px; background:#f9f9f9; border-radius:8px;">
                ...
                <input type="text" id="sfb-common-note" class="regular-text" placeholder="যেমন: সাবধানে ডেলিভারি করবেন">
                
                <p class="submit">
                    <button type="button" id="sfb-submit-bulk-btn" class="button button-primary button-large">সবগুলো একসাথে বুকিং দিন</button>
                </p>
            </div>
        </div>
    </div>
